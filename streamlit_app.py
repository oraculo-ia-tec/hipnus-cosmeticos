...
with col_left:
    st.html("""
    <style>
    /* Painel esquerdo: garante altura total e padding interno */
    [data-testid="stHorizontalBlock"] > div[data-testid="stColumn"]:first-child
    [data-testid="stHtml"] {
      height: 100%;
    }
...
with col_right:
    ...
    ">
      ...
      <p style="font-size: .85rem; color: #6b7280; line-height: 1.5; margin: 0;">
...
# ─ Lógica de autenticação (fora das colunas, processa no mesmo ciclo) ────────
if btn_entrar:
