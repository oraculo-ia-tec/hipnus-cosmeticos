...
sidebar_logo()
sidebar_user_info()
if st.sidebar.button("🚶 Sair", use_container_width=True, key="logout_cart"):
    logout()
...
cart = ui._cart()
if not cart:
    components.empty_state(icon="🛒", title="Carrinho vazio", message="Adicione produtos pelo Catálogo ou pela Loja do Parceiro.")
else:
