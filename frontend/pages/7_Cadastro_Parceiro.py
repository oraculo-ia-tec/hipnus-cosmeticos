...
components.page_header(
    ...
    subtitle="Preencha os dados da empresa para solicitar acesso à área B2B.",
)
...
with st.form("form_parceiro"):
    ...
    estado    = c3.selectbox("Estado", ["", "AC","AL","AP","AM","BA","CE","DF","ES","GO",
                              "MA","MT","MS","MG","PA","PB","PR","PE","PI","RJ",
                              "RN","RS","RO","RR","SC","SP","SE","TO"])
    segmento  = c4.selectbox("Segmento", ["", "Salão de beleza", "Barbearia",
                              "Distribuidora", "Loja de cosméticos", "Outro"])
...
if submitted:
    if not nome or not email:
        ...
        payload = {
            ...
            "document": cpf_cnpj, "company": empresa,
            "city": cidade, "state": estado, "segment": segmento,
